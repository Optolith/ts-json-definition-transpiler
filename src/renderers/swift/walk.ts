...
import { cleanupUndefinedKeys } from "./ast/creators.js"
...
const walkEnumDeclNode = (
  ...
  cleanupUndefinedKeys({
    ...
    genericParameterClause:
      node.genericParameterClause && fn(node.genericParameterClause),
...
const walkIdentifierTypeNode = (
  ...
  cleanupUndefinedKeys({
    ...
    genericArgumentClause:
      node.genericArgumentClause && fn(node.genericArgumentClause),
  })
