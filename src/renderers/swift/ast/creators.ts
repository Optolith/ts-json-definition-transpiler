...
import { isIfExprNode } from "./guards.js"
...
export const binaryOperatorToken = (
  operator: string
): Ast.BinaryOperatorToken => ({
...
export const enumDecl = (
  ...
  cleanupUndefinedKeys({
    ...
    inheritanceClause:
      options.inheritanceClause && inheritanceClause(options.inheritanceClause),
...
export const arrayExpr = (
  elements: readonly Ast.ExprNode[]
): Ast.ArrayExprNode => ({
...
export const binaryOperatorExpr = (
  operator: string
): Ast.BinaryOperatorExprNode => ({
  kind: Ast.NodeKind.BinaryOperatorExpr,
  operator: binaryOperatorToken(operator),
})

export const booleanLiteralExpr = (
  value: boolean
): Ast.BooleanLiteralExprNode => ({
...
export const integerLiteralExpr = (
  value: number
): Ast.IntegerLiteralExprNode => ({
...
export const stringLiteralExpr = (
  value: string
): Ast.StringLiteralExprNode => ({
...
export const tupleExpr = (
  elements: readonly Ast.LabeledExprNode[]
): Ast.TupleExprNode => ({
...
export const identifierType = (
  ...
  cleanupUndefinedKeys({
    ...
    genericArgumentClause:
      genericArguments && genericArgumentClause(genericArguments),
  })

export const optionalType = (
  wrappedType: Ast.TypeNode
): Ast.OptionalTypeNode => ({
...
export const arrayElementList = (
  elements: readonly Ast.ExprNode[]
): Ast.ArrayElementListNode => ({
...
export const codeBlockItem = (
  item: Ast.CodeBlockItemNode_Item
): Ast.CodeBlockItemNode => ({
...
export const compositionTypeElement = (
  type: Ast.TypeNode
): Ast.CompositionTypeElementNode => ({
...
export const declModifier = (
  name: Ast.Token,
  detail?: Ast.Token
): Ast.DeclModifierNode =>
  cleanupUndefinedKeys({
...
export const declNameArgument = (
  name: Ast.Token
): Ast.DeclNameArgumentNode => ({
...
export const enumCaseParameter = (
  ...
  cleanupUndefinedKeys({
    ...
    secondName:
      secondName === undefined ? undefined : identifierToken(secondName),
    type,
  })
...
export const functionParameter = (
  ...
  cleanupUndefinedKeys({
    ...
    type,
    defaultValue:
      options.defaultValue && initializerClause(options.defaultValue),
  })
...
export const genericArgument = (
  argument: Ast.TypeNode
): Ast.GenericArgumentNode => ({
...
export const memberBlockItem = (
  decl: Ast.DeclNode
): Ast.MemberBlockItemNode => ({
...
export const switchCaseItem = (
  pattern: Ast.PatternNode
): Ast.SwitchCaseItemNode => ({
  kind: Ast.NodeKind.SwitchCaseItem,
  pattern,
})

export const switchCaseList = (
  cases: readonly Ast.SwitchCaseNode[]
...
export const attributeList = (
  attributes: readonly Ast.AttributeNode[]
): Ast.AttributeListNode => ({
...
export const availabilityTokenArgument = (
  token: Ast.Token
): Ast.AvailabilityTokenArgumentNode => ({
...
export const functionEffectSpecifiers = (options: {
  ...
  cleanupUndefinedKeys({
    ...
    asyncSpecifier:
      options.asyncSpecifier && keywordToken(options.asyncSpecifier),
...
export const initializerClause = (
  rawValue: Ast.ExprNode
): Ast.InitializerClauseNode => ({
...
export const typeInitializerClause = (
  value: Ast.TypeNode
): Ast.TypeInitializerClauseNode => ({
